package com.example.travelassistant.Calendar;
...
public class AddEvent extends AppCompatActivity implements com.sleepbot.datetimepicker.time.TimePickerDialog.OnTimeSetListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.sleepbot.datetimepicker.time.TimePickerDialog timePickerDialog = com.sleepbot.datetimepicker.time.TimePickerDialog.newInstance(AddEvent.this, calendar.get(java.util.Calendar.HOUR_OF_DAY), calendar.get(java.util.Calendar.MINUTE),false, false);
        ...
        if (savedInstanceState != null) {
            com.sleepbot.datetimepicker.time.TimePickerDialog tpd = (com.sleepbot.datetimepicker.time.TimePickerDialog) getSupportFragmentManager().findFragmentByTag(TIMEPICKER_TAG);
            if (tpd != null) {
